...
const T = {
  en: {
    ...
    your_name_req:   "Your name",
    your_phone:      "Phone number",
    your_pin:        "4-digit PIN",
    set_pin:         "Create a PIN",
    login_btn:       "Sign In",
    register_btn:    "Create Account",
    start_browsing:  "Browse Menu",
    view_order:      "View Order",
    place_order_now: "Place Order",
    preparing_msg:   "Your order is being prepared…",
    ready_msg:       "Your order is ready! 🎉",
    completed_msg:   "Order completed. Thank you!",
    order_again:     "Order More",
    your_order_num:  "Order",
  ...
  ar: {
    ...
    your_name_opt:   "اسمك (اختياري)",
    your_name_req:   "اسمك",
    your_phone:      "رقم الهاتف",
    your_pin:        "رمز PIN (4 أرقام)",
    set_pin:         "أنشئ رمز PIN",
    login_btn:       "تسجيل الدخول",
    register_btn:    "إنشاء حساب",
    start_browsing:  "تصفح القائمة",
    view_order:      "عرض الطلب",
    place_order_now: "تأكيد الطلب",
    preparing_msg:   "طلبك قيد التحضير…",
    ready_msg:       "طلبك جاهز! 🎉",
    completed_msg:   "اكتمل طلبك. شكراً لك!",
    order_again:     "طلب المزيد",
    your_order_num:  "طلب",
